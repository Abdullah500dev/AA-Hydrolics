          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 dark:text-gray-300">
                <p>
                  Founded in 2008, AA Hydraulics has grown from a small workshop to a leading manufacturer of hydraulic presses in Pakistan. Our journey has been driven by a passion for engineering excellence and a commitment to quality.
                </p>
                <p>
